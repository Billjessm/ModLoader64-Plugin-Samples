...
const S_BUTTON = 0x80073F66;
const C_BUTTON = 0x801C7673;
const MAP = 0x801C7DC9;
const MAGIC = 0x801C2625;
...
export class RainbowEverything implements IPlugin {
  ...
  onTick(): void 
  {
    ...
    this.ModLoader.emulator.rdramWrite8(heartBeatOOffset, currentColor.r);
    this.ModLoader.emulator.rdramWrite8(heartBeatOOffset + 2, currentColor.g);
    this.ModLoader.emulator.rdramWrite8(heartBeatOOffset + 4, currentColor.b);
    ...
    this.ModLoader.emulator.rdramWrite8(heartOOffset, currentColor.r);
    this.ModLoader.emulator.rdramWrite8(heartOOffset + 2, currentColor.g);
    this.ModLoader.emulator.rdramWrite8(heartOOffset + 4, currentColor.b);
